...
func TestPlan(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			floatingIPs: []resource.FloatingIP{
				{Provider: resource.ProviderNameMock, MockID: 1, Location: "nbg1", NetworkZone: "eu-central", CurrentTarget: "1", FloatingIPName: "floating-ip-1"},
				{Provider: resource.ProviderNameMock, MockID: 2, Location: "nbg1", NetworkZone: "eu-central", CurrentTarget: "2", FloatingIPName: "floating-ip-2"},
				{Provider: resource.ProviderNameMock, MockID: 3, Location: "nbg1", NetworkZone: "eu-central", CurrentTarget: "3", FloatingIPName: "floating-ip-3"},
			},
			expectedPlan: Plan{
		...
		},
		{
			...
			floatingIPs: []resource.FloatingIP{ // They start out all on server 1
				{Provider: resource.ProviderNameMock, MockID: 1, Location: "nbg1", NetworkZone: "eu-central", CurrentTarget: "1", FloatingIPName: "floating-ip-1"},
				{Provider: resource.ProviderNameMock, MockID: 2, Location: "nbg1", NetworkZone: "eu-central", CurrentTarget: "1", FloatingIPName: "floating-ip-2"},
				{Provider: resource.ProviderNameMock, MockID: 3, Location: "nbg1", NetworkZone: "eu-central", CurrentTarget: "1", FloatingIPName: "floating-ip-3"},
			},
			expectedPlan: Plan{
				Actions: []ReassignFloatingIPAction{
		...
		},
		{
			...
			floatingIPs: []resource.FloatingIP{ // Start unassigned.
				{Provider: resource.ProviderNameMock, MockID: 1, Location: "nbg1", NetworkZone: "eu-central", CurrentTarget: "", FloatingIPName: "floating-ip-1"},
				{Provider: resource.ProviderNameMock, MockID: 2, Location: "nbg1", NetworkZone: "eu-central", CurrentTarget: "", FloatingIPName: "floating-ip-2"},
				{Provider: resource.ProviderNameMock, MockID: 3, Location: "nbg1", NetworkZone: "eu-central", CurrentTarget: "", FloatingIPName: "floating-ip-3"},
			},
			expectedPlan: Plan{
				Actions: []ReassignFloatingIPAction{
		...
		},
		{
			...
			floatingIPs: []resource.FloatingIP{
				{Provider: resource.ProviderNameMock, MockID: 1, Location: "nbg1", NetworkZone: "eu-central", CurrentTarget: "", FloatingIPName: "floating-ip-1"},
				{Provider: resource.ProviderNameMock, MockID: 2, Location: "fsn1", NetworkZone: "eu-central", CurrentTarget: "", FloatingIPName: "floating-ip-2"},
				{Provider: resource.ProviderNameMock, MockID: 3, Location: "fsn1", NetworkZone: "eu-central", CurrentTarget: "", FloatingIPName: "floating-ip-3"},
			},
			expectedPlan: Plan{
				Actions: []ReassignFloatingIPAction{
					{ServerID: "1", FloatingIPID: "1"},
		...
		},
		{
			...
			floatingIPs: []resource.FloatingIP{
				{Provider: resource.ProviderNameMock, MockID: 1, Location: "nbg1", NetworkZone: "eu-central", CurrentTarget: "1234", FloatingIPName: "floating-ip-1"},
			},
			expectedPlan: Plan{
				Actions: []ReassignFloatingIPAction{},
			},
